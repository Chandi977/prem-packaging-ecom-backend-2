...
function sendCustomPackagingEmail(receiverEmail, subject, data) {
  ...
  sendSmtpEmail.to = [{ email: receiverEmail, name: "Recipient Name" }];
...
module.exports = sendCustomPackagingEmail;
